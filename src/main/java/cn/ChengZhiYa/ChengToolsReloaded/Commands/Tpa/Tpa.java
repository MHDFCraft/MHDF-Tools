...
public final class Tpa implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull java.lang.String label, @NotNull java.lang.String[] args) {
        if (sender instanceof Player) {
            if (args.length == 1) {
                java.lang.String TpaPlayerName = args[0];
                ...
                StringHasMap.getHasMap().put(PlayerName + "_Temp_TpaPlayerName", TpaPlayer.getName());
                BooleanHasMap.getHasMap().put(PlayerName + "_Temp_Tpa", true);
