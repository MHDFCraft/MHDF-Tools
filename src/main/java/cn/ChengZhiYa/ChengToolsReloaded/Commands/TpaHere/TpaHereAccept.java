...
public final class TpaHereAccept implements CommandExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull java.lang.String label, @NotNull java.lang.String[] args) {
        if (sender instanceof Player) {
            if (args.length == 1) {
                ...
                AcceptPlayer.sendMessage(getLang("TpaHere.TeleportDone",AcceptPlayerName));
                player.sendMessage(getLang("TpaHere.AcceptDone",AcceptPlayerName));
