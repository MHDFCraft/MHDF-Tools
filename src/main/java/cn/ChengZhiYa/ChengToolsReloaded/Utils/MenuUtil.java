    ...
    public static void OpenHomeMenu(Player player, int Page) {
        Bukkit.getScheduler().runTaskAsynchronously(ChengToolsReloaded.instance, () -> {
            ...
            try {
                ...
                PreparedStatement ps = connection.prepareStatement("SELECT * FROM ChengTools_Home WHERE Owner = ? LIMIT " + HomeSize + " OFFSET ?");
            ...
            Bukkit.getScheduler().runTask(ChengToolsReloaded.instance, () -> player.openInventory(Menu));
        });
    }
}
