...
public class multi {
    ...
    public static String getLang(String LangVaule, String Vaule1) {
        File LangData = new File(main.main.getDataFolder() + "/lang.yml");
        YamlConfiguration LangFileData = YamlConfiguration.loadConfiguration(LangData);
        return ChatColor(Objects.requireNonNull(LangFileData.getString(LangVaule)).replaceAll("%1",Vaule1));
    }

    public static String getLang(String LangVaule, String Vaule1, String Vaule2) {
        File LangData = new File(main.main.getDataFolder() + "/lang.yml");
        YamlConfiguration LangFileData = YamlConfiguration.loadConfiguration(LangData);
        return ChatColor(Objects.requireNonNull(LangFileData.getString(LangVaule)).replaceAll("%1",Vaule1).replaceAll("%2",Vaule2));
    }

    public static String getLang(String LangVaule, String Vaule1, String Vaule2, String Vaule3) {
        File LangData = new File(main.main.getDataFolder() + "/lang.yml");
        YamlConfiguration LangFileData = YamlConfiguration.loadConfiguration(LangData);
        return ChatColor(Objects.requireNonNull(LangFileData.getString(LangVaule)).replaceAll("%1",Vaule1).replaceAll("%2",Vaule2).replaceAll("%3",Vaule3));
    }
}
