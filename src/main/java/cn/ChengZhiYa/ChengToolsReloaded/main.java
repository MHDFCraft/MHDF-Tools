...
public final class main extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("VanillaOpWhitelist.Enable")) {
            BukkitTask WhiteListTask = new VanillaOpWhitelist_Task(this).runTaskTimer(this, 0L, 20L);
        ...
        if (getConfig().getBoolean("SpawnSettings.Enable")) {
            multi.registerCommand(this, new spawn(), "Spawn命令", "spawn");
            multi.registerCommand(this, new setspawn(), "SetSpawn命令", "setspawn");
        }
        ...
        if (getConfig().getBoolean("IpCommandEnable")) {
            multi.registerCommand(this, new Ip(), "查询玩家IP与IP归属地命令", "ip");
        }
        ...
        if (getConfig().getBoolean("PointEnable")) {
            multi.registerCommand(this, new Point(), "点券系统", "point");
            multi.registerCommand(this, new Point(), "点券系统", "p");
        }
        if (getConfig().getBoolean("InvseeEnable")) {
            multi.registerCommand(this, new Invsee(), "Invsee系统", "invsee");
        }
        if (getConfig().getBoolean("HatEnable")) {
            multi.registerCommand(this, new Hat(), "Hat系统", "hat");
        }
        if (getConfig().getBoolean("TpahereEnable")) {
            multi.registerCommand(this, new TpaHere(), "Tpahere系统", "tpahere");
            multi.registerCommand(this, new TpaHereAccept(), "接受Tpahere", "tpahereaccept");
            multi.registerCommand(this, new TpaHereDefuse(), "拒绝Tpahere", "tpaheredefuse");
            BukkitTask TpahereTime = new TpaHere_Time(this).runTaskTimer(this, 0L, 20);
