...
public final class PluginManage implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        if (sender.hasPermission("MHDFTools.Command.PLuginManage")) {
            if (args.length == 1) {
            ...
            if (args.length > 2) {
                if (args[0].equals("load")) {
                    ...
                    if (MHDFTools.instance.getConfig().getStringList("PluginManageSettings.WhiteListPluginList").contains(args[1])) {
    ...
    public List<String> onTabComplete(CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        if (sender.hasPermission("MHDFTools.PLuginManage")) {
            if (args.length == 1) {
