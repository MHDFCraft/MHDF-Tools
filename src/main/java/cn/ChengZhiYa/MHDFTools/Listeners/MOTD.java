...
public final class MOTD implements Listener {
    ...
    public void On_Event(PaperServerListPingEvent event) {
        event.setMotd(ChatColor(null, Objects.requireNonNull(MHDFTools.instance.getConfig().getString("MOTDSettings.Line1"))) + "\n" +
                ChatColor(null, Objects.requireNonNull(MHDFTools.instance.getConfig().getString("MOTDSettings.Line2"))));
